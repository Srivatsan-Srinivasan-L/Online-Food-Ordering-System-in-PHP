    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        <li class="nav-item">
            <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3" data-bs-toggle="pill" href="#tab-1">
                ...
                <div class="ps-3">
                    <h6 class="filter" data-filter="<?= $data_filter; ?>"><?= $row["food_category"]; ?></h6>
                </div>
            </a>
        </li>
        <?php
        ...
        <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        <img class="flex-shrink-0 img-fluid rounded" src="../../admin/uploads/<?php echo $row["food_image"]?>" alt="" style="width: 80px;">
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span><?php echo $row["food_name"]?></span>
                                                <span class="text-primary"><?php echo $row["food_original_price"]?></span>
                                            </h5>
